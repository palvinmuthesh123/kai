...
import Search from '../../assets/svg/Footer/Search.svg'
import People from '../../assets/svg/Footer/People.svg'
import Expert from '../../assets/svg/Footer/Expert.svg'
import Post from '../../assets/svg/modal/Post.svg'
    ...
    return (
        <><SafeAreaView style={styles.appbar}>
            ...
            <TouchableOpacity
                ...
                <View>
                    {props.dash?<People/>:props.expert? <Expert/>:<Schedule/>}
                </View>
            ...
            <TouchableOpacity
                ...
                <View>
                {props.dash?<Search/>:props.expert? <Search/>:<Bookmark/>}
                </View>
